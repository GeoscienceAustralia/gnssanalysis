...
def get_frame_of_day(
    date_or_j2000,
    itrf_path_or_df: _pd.DataFrame | str,
    discon_path_or_df: _pd.DataFrame | str,
    psd_path_or_df: None | _pd.DataFrame | str = None,
    list_path_or_df: None | _pd.DataFrame | str | _np.ndarray = None,
):
