...
def test_ginan_trop():
    # 10 records, 8 fields
    assert read_tro_solution_bytes(GINAN_TROP_FILE.encode("utf-8"), trop_mode="Ginan").shape == (10, 8)


def test_bernese_trop():
    # 10 records, 6 fields
    assert read_tro_solution_bytes(BERNESE_TROP_FILE.encode("utf-8"), trop_mode="Bernese").shape == (10, 6)
